		...
		<div className="w-full min-h-32  shadow-gray-950 shadow-inner flex flex-col justify-between items-start px-4 py-8 bg-slate-800 text-white">
			...
			<div className="flex items-center justify-start w-full p-4 flex-wrap">
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>Pincode - 226021</span>
					<span>
						<Link
							to={"mailto:contact.2300520100061@ietlucknow.ac.in"}
							target="_blank"
				...
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://www.linkedin.com/in/sandeep-singh-2k27"
							target="_blank"
							rel="noreferrer"
						>
							LinkedIn
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://github.com/sandeep-2k27"
							target="_blank"
							rel="noreferrer"
						>
							Github
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="mailto:contact.2300520100061@ietlucknow.ac.in"
							target="_blank"
							rel="noreferrer"
						>
							E-Mail
